...
void CrateTypeClass::AddNewINIList(CCINIClass* pINI, const char* pSection, const char* pKey)
{
	DynamicVectorClass<CrateTypeClass*> objectsList;
	...
	{
		if (CrateTypeClass::Find(cur))
			continue;

		objectsList.AddItem(CrateTypeClass::Allocate(cur));
	}
