...
#define FILE_DESCRIPTION "ExtraPhobos, Ares-compatible YR engine extension, base on Phobos"
...
#define FILE_DESCRIPTION "Unstable nightly devbuild of ExtraPhobos engine extension"
