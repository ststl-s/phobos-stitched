...
#define FILE_DESCRIPTION "Ehance bos, Ares-compatible YR engine extension, base on Phobos"
...
#define FILE_DESCRIPTION "Unstable nightly devbuild of Ehance bos engine extension"
...
#define SAVEGAME_ID ((BUILD_NUMBER << 24) | (BUILD_NUMBER << 12) | (BUILD_NUMBER))
#define FILE_DESCRIPTION "Development build of Ehance bos engine extension, base on Phobos Build #" _STR(BUILD_NUMBER)
